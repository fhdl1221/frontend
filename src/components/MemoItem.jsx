...
// dueDate를 "YYYY년 MM월 DD일 HH:MM" 형식으로 변환하는 함수
  ...
  return (
    <li className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-6 py-4 border border-gray-200 rounded-lg bg-white">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="text-sm px-4 py-2 text-red-400 hover:text-red-700 transition-colors"
        >
          삭제
        </button>
      </div>
