...
export default function StatisticsPage() {
  ...
  if (loading || !dashboardData) {
    // [수정] dashboardData가 null일 때도 로딩 표시
    return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl p-6 text-white shadow-lg">
            ...
            {/* [수정] 데이터가 BigDecimal이므로 .toFixed(1) 등으로 포매팅 */}
            <div className="text-4xl font-bold mb-2">
              {Number(dashboardData.averageStress).toFixed(1)}/5
            </div>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl p-6 text-white shadow-lg">
            ...
            <div className="text-4xl font-bold mb-2">
              {dashboardData.contentViews.length}
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-100">
          ...
          {/* [수정] weeklyStress 데이터가 0.0일 수 있으므로 포매팅 (StressChart가 처리할 수 있음) */}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li>
                  • 업무 과다가 주요 원인이에요. 업무 시간 관리를 개선해보세요
                </li>
